...
def test_infogram_iris():
    ...
    infogram_model = H2OInfoGramEstimator(seed = 12345, distribution = 'multinomial', build_final_model=True) # build infogram model with default settings
    infogram_model.train(x=x, y=target, training_frame=fr)
    infogram_final_scoring_model = infogram_model._model_json["output"]["scoring_history"]
    ...
    pyunit_utils.assert_H2OTwoDimTable_equal_upto(infogram_final_scoring_model, 
