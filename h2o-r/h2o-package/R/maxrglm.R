                        ...
                        max_predictor_number = 1)
{
  ...
  model <- .h2o.modelJob('maxrglm', parms, h2oRestApiVersion=3, verbose=FALSE)
  return(model)
}
.h2o.train_segments_maxrglm <- function(x,
                                        y,
                                        training_frame,
                                        validation_frame = NULL,
                                        nfolds = 0,
                                        ...
                                        parallelism = 1)
{
  ...
  segment_models <- .h2o.segmentModelsJob('maxrglm', segment_parms, parms, h2oRestApiVersion=3)
